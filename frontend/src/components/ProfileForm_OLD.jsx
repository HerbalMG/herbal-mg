...
export default function ProfileForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (isNewUser) {
          const profileResponse = await fetch(`${API_BASE_URL}/auth/profile/${userId}`, {
            credentials: 'include',
          });
        ...
        // Fetch addresses
        const addressResponse = await fetch(`${API_BASE_URL}/customer/${userId}/addresses`, {
          credentials: 'include',
        });
  ...
  const saveAddress = async (index) => {
    ...
    try {
      ...
      if (addr.id) {
        // Update
        response = await fetch(`${API_BASE_URL}/customer/${userId}/addresses/${addr.id}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          credentials: 'include',
        ...
        // Create
        response = await fetch(`${API_BASE_URL}/customer/${userId}/addresses`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          credentials: 'include',
          body: JSON.stringify(payload),
  ...
  const handleRemove = async (index) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/customer/${userId}/addresses/${addr.id}`, {
        method: 'DELETE',
        credentials: 'include',
      });
  ...
  const setDefault = async (index) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/customer/${userId}/addresses/${addr.id}/set-default`, {
        method: 'POST',
        credentials: 'include',
      });
      const data = await response.json();
